 ...
 */
public final class QPermissions {
     ...
     * 私有化构造函数
     */
    private QPermissions(Activity activity) {
        mActivity = activity;
    }

    public static QPermissions with(Context context) {
     ...
     */
    public static QPermissions with(Activity activity) {
        return new QPermissions(activity);
    }
     ...
     * 设置权限组
     */
    public QPermissions permission(String... permissions) {
     ...
     * 设置权限组
     */
    public QPermissions permission(List<String> permissions) {
        if (mPermissions == null) {
