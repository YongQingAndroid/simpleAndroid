 ...
 */
public abstract class QOrientationHelper {
    ...
    private QOrientationHelper(RecyclerView.LayoutManager layoutManager) {
        mLayoutManager = layoutManager;
    }

    /**
     * Returns the {@link RecyclerView.LayoutManager LayoutManager} that
     * is associated with this QOrientationHelper.
     */
    ...
    /**
     * Creates an QOrientationHelper for the given LayoutManager and orientation.
     *
     * @param layoutManager LayoutManager to attach to
     * @param orientation   Desired orientation. Should be {@link #HORIZONTAL} or {@link #VERTICAL}
     * @return A new QOrientationHelper
     */
    public static QOrientationHelper createOrientationHelper(
    ...
    /**
     * Creates a horizontal QOrientationHelper for the given LayoutManager.
     *
     * @param layoutManager The LayoutManager to attach to.
     * @return A new QOrientationHelper
     */
    public static QOrientationHelper createHorizontalHelper(
            RecyclerView.LayoutManager layoutManager) {
        return new QOrientationHelper(layoutManager) {
            @Override
...
//                mLayoutManager.offsetChildrenHorizontal(amount);
            ...
            public void offsetChildrenHorizontal(@Px int dx) {
                final int childCount = layoutManager.mChildHelper.getChildCount();
                for (int i = 0; i < childCount; i++) {
                    layoutManager.mChildHelper.getChildAt(i).offsetLeftAndRight(dx);
                }
            }
    ...
    /**
     * Creates a vertical QOrientationHelper for the given LayoutManager.
     *
     * @param layoutManager The LayoutManager to attach to.
     * @return A new QOrientationHelper
     */
    public static QOrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new QOrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
...
//                mLayoutManager.offsetChildrenVertical(amount)
            ...
            public void offsetChildrenVertical(@Px int dy) {
                ...
                View mView = null;
                int index = -1;
                final int childCount = mLayoutManager.mChildHelper.getChildCount();
                for (int i = 0; i < childCount; i++) {
                    mView = mLayoutManager.mChildHelper.getChildAt(i);
                    index = mLayoutManager.getPosition(mView);
                    if (index == 5 && mView.getY() <= 100) {
    ...
    static class Lp extends RecyclerView.LayoutParams {

        public Lp(int width, int height) {
            super(width, height);
        }
