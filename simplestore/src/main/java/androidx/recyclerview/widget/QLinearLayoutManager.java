 ...
 */
public class QLinearLayoutManager extends RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {

    private static final String TAG = "QLinearLayoutManager";
     ...
     * helps {@link QLinearLayoutManager} make those decisions.
     */
    QOrientationHelper mOrientationHelper;
    ...
    /**
     * Creates a vertical QLinearLayoutManager
     *
     ...
     */
    public QLinearLayoutManager(Context context, @RecyclerView.Orientation int orientation,
     ...
     */
    public QLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    /**
     * Sets the orientation of the layout. {@link QLinearLayoutManager}
    ...
    public void setOrientation(@RecyclerView.Orientation int orientation) {
        ...
        if (orientation != mOrientation || mOrientationHelper == null) {
            mOrientationHelper =
                    QOrientationHelper.createOrientationHelper(this, orientation);
     ...
     *
     * <p>By default, {@link QLinearLayoutManager} lays out 1 extra page
     ...
     * location, where 1) the extra content helps QLinearLayoutManager know in advance when its
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return QScrollbarHelper.computeScrollOffset(state, mOrientationHelper,
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return QScrollbarHelper.computeScrollExtent(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return QScrollbarHelper.computeScrollRange(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
                this, mSmoothScrollbarEnabled);
    }
     ...
     * <code>4</code> to this method for each inner RecyclerView's QLinearLayoutManager will enable
    ...
    public void collectAdjacentPrefetchPositions(int dx, int dy, RecyclerView.State state,
            LayoutPrefetchRegistry layoutPrefetchRegistry) {
        @SuppressLint("WrongConstant") int delta = (mOrientation == HORIZONTAL) ? dx : dy;
     ...
     * @see QLinearLayoutManager.LayoutState#mLayoutDirection
     */
     ...
     * independent from the rest of the {@link QLinearLayoutManager}
