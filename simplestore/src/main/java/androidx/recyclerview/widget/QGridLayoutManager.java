 ...
 */
public class QGridLayoutManager extends LinearLayoutManager {

    private static final boolean DEBUG = false;
    private static final String TAG = "QGridLayoutManager";
     ...
     */
    public QGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                             int defStyleRes) {
    ...
    /**
     * Creates a vertical QGridLayoutManager
     *
     * @param context Current context, will be used to access resources.
     * @param spanCount The number of columns in the grid
     */
    public QGridLayoutManager(Context context, int spanCount) {
        super(context);
    ...
    /**
     * stackFromEnd is not supported by QGridLayoutManager. Consider using
    ...
    public void setStackFromEnd(boolean stackFromEnd) {
        if (stackFromEnd) {
            throw new UnsupportedOperationException(
                    "QGridLayoutManager does not support stack from end."
    ...
    /**
     * Returns the current {@link SpanSizeLookup} used by the QGridLayoutManager.
     *
     * @return The current {@link SpanSizeLookup} used by the QGridLayoutManager.
     */
        ...
        while (count < mSpanCount && layoutState.hasMore(state) && remainingSpan > 0) {
            ...
            if (spanSize > mSpanCount) {
                throw new IllegalArgumentException("Item at position " + pos + " requires "
                        + spanSize + " spans but QGridLayoutManager has only " + mSpanCount
                        + " spans.");
            }
            remainingSpan -= spanSize;
            if (remainingSpan < 0) {
     ...
     *
     * @see QGridLayoutManager#setSpanSizeLookup(SpanSizeLookup)
     */
    public abstract static class SpanSizeLookup {
        ...
        /**
         * Clears the span index cache. QGridLayoutManager automatically calls this method when
         ...
         * {@link #getSpanSize(int)}. QGridLayoutManager does not call this method for
    ...
    /**
     * LayoutParams used by QGridLayoutManager.
     * <p>
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
         ...
         * even if the layout is RTL. In a vertical QGridLayoutManager, <b>leftmost</b> span is span
